...
object EGXStocks {
    val stocks = listOf(
        ...
        Stock("MFPC", "Misr Pharma", "مصر للمستحضرات الطبية", "Healthcare"),
        Stock("EPCO", "Egyptian Pharma", "المصرية للأدوية والكيماويات", "Healthcare"),
        
        // Industrial
        Stock("EGAL", "Ezz Al Dekheila Steel", "حديد الدخيلة", "Industrial"),
        ...
        Stock("ABUK", "Abu Qir Fertilizers", "أبو قير للأسمدة", "Diversified"),
        Stock("BONY", "Beni Suef Cement", "بني سويف للأسمنت", "Diversified"),
